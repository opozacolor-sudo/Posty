...
export const INSTAGRAM_OAUTH_LOCALE_COOKIE = "instagram_oauth_locale";
export const INSTAGRAM_OAUTH_COOKIE_MAX_AGE = 60 * 10;
...
export function setInstagramOAuthCookies(
  ...
  response.cookies.set(INSTAGRAM_OAUTH_LOCALE_COOKIE, locale, {
    httpOnly: true,
    secure: process.env.NODE_ENV === "production",
    sameSite: "lax",
    maxAge: INSTAGRAM_OAUTH_COOKIE_MAX_AGE,
